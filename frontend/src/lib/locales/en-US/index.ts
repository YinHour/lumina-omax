export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Lumina API server could not be reached",
  ...
  auth: {
    ...
    usernamePlaceholder: "Enter your username (default: admin)",
    password: "Password",
    enterPlatform: "Enter Platform",
    platformTagline: "Lumiton·Omax Research Data Platform",
    tabLogin: "Login",
    tabRegister: "Register",
    regUsername: "Username",
    regUsernamePlaceholder: "e.g. john_doe",
    regDisplayName: "Full Name / Display Name",
    regDisplayNamePlaceholder: "John Doe (Engineering Team)",
    regPassword: "Set Password",
    regPasswordPlaceholder: "Enter a strong password",
    regConfirmPassword: "Confirm Password",
    regConfirmPasswordPlaceholder: "Re-enter your password",
    regAllFieldsRequired: "All fields are required",
    regPasswordMismatch: "Passwords do not match",
    regSuccess: "Registration submitted successfully! Your account is currently pending approval. Please contact an administrator to activate your account before logging in.",
    regFailed: "Registration failed. Please try again later.",
    regNetworkError: "Network connection failed. Please check the backend service.",
    regSubmitting: "Submitting application...",
    regSubmit: "Submit Registration",
    regApprovalHint: "ℹ️ Note: After registration, an administrator must approve and activate your account in 'System Settings → Member Approval' before you can log in.",
    signinLoading: "Signing in...",
    platformTitle: "Research Data Platform",
    platformDesc: "Oil Well Chemical Intelligent Decision & Literature LLM System",
    configVersion: "Platform Version: v",
  },
  navigation: {
    collect: "Collect",
    process: "Process",
  ...
  notebooks: {
    ...
    passwordRequiredDesc: "This notebook requires a password to access.",
    enterPassword: "Enter password",
    unlock: "Unlock",
    incorrectPassword: "Incorrect password",
    leaveBlankForNoPassword: "Leave blank for no password",
    yourName: "Your name",
    passwordOptional: "Password (Optional)",
    creatorNameOptional: "Creator Name (Optional)",
    passwordSettings: "Password",
    passwordManagement: "Password Management",
    passwordManagementDesc: "Set, change, or remove the notebook password",
    passwordUpdated: "Password updated successfully",
    passwordSetSuccess: "Password set successfully",
    passwordChangedSuccess: "Password changed successfully",
    passwordRemovedSuccess: "Password removed successfully",
    setPassword: "Set",
    setPasswordBtn: "Set Password",
    setPasswordPlaceholder: "Enter password (at least 6 characters)",
    changePassword: "Change",
    changePasswordBtn: "Change Password",
    removePassword: "Remove",
    removePasswordBtn: "Remove Password",
  ...
  sources: {
    ...
    downloadMarkdownPackage: "Download Markdown + Images",
    ...
    selectMultipleFilesHint: "Select multiple files to batch import. Supported: Documents (PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, XLSM, EPUB, TXT, MD)",
    ...
    batchDeleteConfirm: "Are you sure you want to permanently delete the selected {count} sources?",
    clearSelection: "Clear Selection",
    itemsSelected: "{count} items selected",
    batchDeleteSuccess: "Successfully deleted {count} sources",
    batchPartialSuccess: "Deleted {success} sources, {failed} failed",
    ...
    sourceLimitRemaining: "{remaining} source slot(s) remaining in this notebook (limit {limit}).",
    ...
    pageOf: "Page {page}",
    enterPassword: "Enter password",
    continueUploadQuestion: "Do you want to continue uploading?",
    cancelNo: "No (Cancel)",
    onlyNonDuplicates: "Only Non-duplicates",
    uploadAll: "Yes (Upload All)",
    setAllFullText: "Set All to Full Text",
    setAllInsights: "Set All to Insights",
    setAllToOff: "Set All to Off",
    incorrectPassword: "Incorrect password",
    pageOfTotal: "Page {page} of {total}, {count} items",
    totalItems: "Total: {count} items",
    filterSources: "Filter sources...",
    noSourcesMatchSearch: "No sources match your search",
    ...
    contextChars: "{count} chars",
    noNewFiles: "No new files uploaded, all were duplicates",
    fileDuplicateSkipped: "File was a duplicate and skipped",
    filteringDuplicates: "Continuing upload, filtering duplicates...",
    continuingDuplicateUpload: "Continuing upload...",
    duplicateFilesDetected: "Duplicate Files Detected",
    duplicateFilesDetectedDesc: "The system detected that the following files may already have been uploaded:",
  },
  profile: {
    title: "Profile",
  ...
  chat: {
    ...
    exportAssistantLabel: "Assistant",
    ...
    crossNotebookDiscovery: "Cross-notebook discovery",
    scientificDatabases: "Scientific databases",
    researchSkills: "Research methods",
    researchSkillsAuto: "Methods: Auto",
    researchSkillsOff: "Methods: Off",
    researchSkillsSelected: "Methods: {count} selected",
    researchSkillsChoose: "Choose up to 3 methods",
    researchSkillsLimit: "Selected methods apply to this request only. Auto mode can load up to 2.",
    researchSkillNames: {
      literatureDoiVerification: "Literature search & DOI verification",
      evidenceCriticalAppraisal: "Evidence grading & critical appraisal",
      competingHypotheses: "Hypothesis generation & comparison",
      doeStatisticalPlan: "DOE & statistical analysis plan",
      chemicalIdentityProperties: "Chemical identity & property verification",
      formulationCompatibilityMatrix: "Formulation compatibility risk matrix",
      hthpBrineValidation: "HTHP & brine validation design",
      scaleUpValidationGates: "Scale-up risks & validation gates",
      structuredResearchReport: "Structured research reporting",
      oilwellCementAdditiveDiagnosis: "Oilwell cement additive diagnosis",
    },
    ...
    activityModelStreaming: "Model is responding...",
    progressWorking: "Working",
    progressReceived: "Question received",
    progressPreparingContext: "Preparing selected material",
    progressContextReady: "Conversation material ready",
    progressPlanning: "Analyzing the question and selecting tools",
    progressInspectingScope: "Checking the research scope",
    progressSearchingNotebook: "Searching this notebook",
    progressReadingEvidence: "Reading relevant evidence",
    progressSearchingCrossNotebook: "Discovering across notebooks",
    progressSearchingWeb: "Searching the web",
    progressInspectingScientificDatabases: "Checking available scientific databases",
    progressSearchingScientificDatabases: "Searching scientific databases",
    progressReadingScientificRecord: "Reading a scientific database record",
    progressLoadingResearchSkills: "Loading research methods",
    progressUsingResearchTool: "Running a research tool",
    progressAwaitingModel: "Waiting for the model",
    progressSynthesizing: "Comparing evidence and organizing findings",
    progressModelStreaming: "Writing the answer",
    progressCompleteSummary: "Completed {count} steps in {seconds}s",
    progressErrorSummary: "Stopped with an error after {seconds}s",
    progressCancelledSummary: "Stopped after {seconds}s",
    progressExpand: "Expand activity",
    progressCollapse: "Collapse activity",
    errorLlmTimeoutPrefix: "⚠️ System notice: ",
    errorLlmTimeoutNotebook: "Model response timed out after {seconds}s.\n\nIn the left \"Sources\" column, switch unrelated sources to \"Insights only\" or \"Not included\", or start a new chat session for this question and try again.",
    errorLlmTimeoutSource: "Model response timed out after {seconds}s.\n\nThis source may be long or the model may be under heavy load. Please try again shortly; if it keeps happening, start a new chat session to clear the history.",
    errorLlmTimeoutAsk: "Ask timed out after {seconds}s.\n\nAsk calls the model multiple times to generate the retrieval strategy, per-source answers, and final synthesis, which takes longer. Please try again shortly; if your question covers a wide topic, consider splitting it into several more specific questions.",
    errorResearchStall: "Research Agent has not made effective progress for a while.\n\nThe run was cancelled after the system detected several research rounds without new conclusions. Please try again shortly; if your question is broad, consider splitting it into more specific questions or reducing the enabled capabilities (web search, scientific databases).",
    errorResearchHardTimeout: "Research Agent exceeded the overall time limit of {seconds}s.\n\nResearch tasks involve multiple rounds of retrieval, reading, and synthesis and can take a while; the run was cancelled after the timeout. Please narrow the question scope or reduce the enabled research capabilities and try again.",
    errorAuthentication: "AI provider authentication failed.\n\nThe API key is invalid or expired. Please ask your administrator to update the credential in Settings → API Keys.",
    errorRateLimit: "AI provider is rate-limited.\n\nToo many requests in a short window. Please wait a minute and try again, or switch to a different model in the chat header.",
    errorConfiguration: "AI model is not configured correctly.\n\nNo usable default model was found for this request. Please ask your administrator to review Settings → Models.",
    errorNetwork: "Could not reach the AI provider.\n\nCheck your network connection. If the server hosts a local model (e.g. Ollama), make sure that service is running. Otherwise try again in a moment.",
    errorExternalService: "AI provider returned an error.\n\nThis is usually a temporary upstream issue (overload, 5xx, context length, payload too large). Try again, reduce the included sources, or switch to a different model.",
    errorInvalidInput: "The request was rejected by the AI provider.\n\nIt may be unsupported or malformed. Try simplifying the question, or report the diagnostic block below to the team.",
    errorNotFound: "A required resource could not be found.\n\nThe notebook, session, or model referenced in this request no longer exists. Refresh the page and try again.",
    errorInternal: "Something went wrong while answering this question.\n\nPlease try again. If it keeps happening, send the diagnostic block below to the team.",
    errorGeneric: "The chat request did not complete.\n\nPlease try again. If it keeps happening, send the diagnostic block below to the team.",
    editAndAskAgain: "Edit and ask again",
    generatingGuide: "Generating notebook guide...",
    generatingGuideDesc: "Preparing the first summary and next-step prompts.",
    guideStepReading: "Reading selected sources",
    guideStepSummarizing: "Summarizing key points",
    guideStepQuestions: "Preparing suggested actions",
  },
  searchPage: {
    askAndSearch: "Ask and Search",
    ...
    askProgressTitle: "Question received, working on it",
    askProgressComplete: "Answer complete",
    askProgressError: "Something went wrong while processing",
    askProgressCancelled: "Processing stopped",
    askProgressElapsed: "{seconds}s elapsed",
    askProgressNote: "Broad questions can take longer because Ask needs to plan, retrieve, read, and summarize.",
    askProgressReceivedTitle: "Received",
    askProgressReceivedDesc: "Confirmed the question and model settings.",
    askProgressPlanningTitle: "Planning",
    askProgressPlanningDesc: "Deciding what materials to look for.",
    askProgressSearchingTitle: "Searching",
    askProgressSearchingDesc: "Searching the knowledge base and reading relevant evidence.",
    askProgressWritingTitle: "Writing",
    askProgressWritingDesc: "Synthesizing evidence into the final answer.",
    coverageTitle: "Retrieval Coverage",
    totalSources: "Total sources",
    embeddedSources: "Searchable sources",
    retrievedSources: "Sources retrieved",
    askHistory: "Ask History",
    noAskHistory: "No Ask history yet",
    restoreHistory: "Restore",
    clearAskHistory: "Clear history",
  },
  podcasts: {
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Lumina to delete uploaded files from the upload folder automatically.",
    sourceBatchLimit: "Notebook source limit",
    sourceBatchLimitHelp: "Maximum number of sources allowed in one notebook, including newly added and existing sources. Default is 50.",
    loadFailed: "Failed to load settings",
    webSearch: "Web Search",
    webSearchDesc: "Configure Tavily Search API for web access",
    ...
    redaction: {
      ...
      enableLabel: "Enable egress redaction",
      enableHelp: "When enabled, prompts sent to external LLM providers replace dictionary terms with aliases, and responses are restored automatically in the UI. Stored content and search always use the original text.",
      dictTitle: "Redaction Dictionary",
      dictHelp: "Manage sensitive-term-to-alias mappings. Each term keeps one stable alias forever; wells, product codes and phone numbers are detected automatically - add person names manually.",
      original: "Sensitive term",
      originalPlaceholder: "e.g. a person or company name",
      alias: "Alias",
      aliasPlaceholder: "e.g. Engineer A",
      category: "Category",
      categories: {
        company: "Company",
        address: "Address",
      ...
      addRule: "Add",
      deleteRule: "Delete",
      noRules: "No dictionary entries yet",
      deleteConfirmTitle: "Delete dictionary entry",
      deleteConfirmDescription: "Delete '{original}'? The term will no longer be replaced automatically.",
      ruleAdded: "Dictionary entry added",
      ruleUpdated: "Dictionary entry updated",
      ruleDeleted: "Dictionary entry deleted",
    },
    userApproval: {
      title: "Member Registration Approval and Account Management",
      description: "Approve, reject, or deactivate members to keep research data isolated.",
      fetchFailed: "Failed to load members",
      statusApproved: "Member account approved and activated.",
      statusRejected: "Member registration request rejected.",
      rolePromoted: "Member promoted to administrator.",
      roleRevoked: "Member administrator permissions removed.",
      ...
      roleRevokeTitle: "Remove administrator permissions",
      rolePromoteTitle: "Promote to administrator",
      ...
      approveActivate: "Approve and activate",
      rejectApplication: "Reject request",
      disableAccount: "Disable account",
      resetPassword: "Reset password",
      confirmApproveTitle: "Approve member account",
      confirmRejectTitle: "Reject or disable member account",
      confirmApproveDesc: "This will activate the member account and allow the member to sign in as a standard user.",
      confirmRejectDesc: "This will reject the registration request or disable the account. The member will not be able to sign in.",
      resetPasswordDesc: "Set a new password for this member and confirm it before saving.",
      newPassword: "New password",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Lumina is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Lumina",
    missingRequiredModels: "Missing required models: {models}. Lumina may not function properly without these.",
    ...
    contextOnDemand: "On-demand retrieval; context changes during each research step",
    contextEstimated: "estimated",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "Context limit not configured",
    contextProgressLabel: "Model context usage: {percent}%",
    contextPending: "Usage updates after the next question",
    editContextWindow: "Edit context window",
    contextWindowDialogTitle: "Model context window",
    contextWindowDialogDesc: "Set the maximum context window for {model}.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Lumina.",
    ...
    test: "Test",
    hasLinkedModels: "This credential has {count} linked model(s).",
    migrateModelsTo: "Migrate models to:",
    key: "Key",
  },
  usage: {
    title: "AI token usage",
    description: "Review token consumption by time period, API key, model, and workflow.",
    period: "Period",
    period7: "7 days",
    period30: "30 days",
    period90: "90 days",
    ...
    dailyUsageDesc: "Total tokens recorded for each day in the selected period.",
    byCredential: "Usage by key",
    byCredentialDesc: "Compare token consumption across stored credentials and environment keys.",
    byUser: "Usage by user",
    byUserDesc: "Compare token consumption across users in the selected scope.",
    recentUsage: "Recent activity",
    recentUsageDesc: "The 50 most recent audited AI operations in the selected scope.",
    noUsage: "No token usage was recorded in this period.",
    loading: "Loading usage...",
    loadError: "Usage data could not be loaded.",
    model: "Model",
    key: "Key",
    user: "User",
    surface: "Workflow",
    ...
    providerReportedHint: "Provider counts are used when available; estimates are labeled.",
    adminHint: "Administrators can audit all users without viewing prompts or responses.",
    surfaceNotebookQuick: "Notebook quick chat",
    surfaceNotebookResearch: "Notebook research chat",
    surfaceSourceChat: "Source chat",
    surfaceGlobalAsk: "Global Ask",
    surfaceTransformation: "Transformation",
    surfaceNoteGeneration: "Note generation",
    surfaceNotebookGuide: "Notebook guide",
    surfaceModelTest: "Model test",
    surfaceCredentialManagement: "Credential management",
    surfaceSourceProcessing: "Source processing",
    surfaceKnowledgeGraph: "Knowledge graph",
    surfaceEmbedding: "Embedding",
    surfaceEmbeddingRebuild: "Embedding rebuild",
    surfaceApi: "API",
    surfaceUnknown: "Other",
  },
  setupBanner: {
    encryptionRequired: "Encryption key not configured",
