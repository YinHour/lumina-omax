...
export const jaJP = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Lumina APIサーバーに到達できませんでした",
  ...
  sources: {
    ...
    downloadMarkdownPackage: "Markdown + 画像をダウンロード",
    moreActions: "その他の操作",
    ...
    selectMultipleFilesHint: "複数ファイルを選択して一括インポート。対応形式：ドキュメント（PDF、DOC、DOCX、PPT、PPTX、XLS、XLSX、XLSM、EPUB、TXT、MD）",
    ...
    continuingDuplicateUpload: "アップロードを続行しています...",
  },
  chat: {
    newSession: "新しい会話",
    selectSession: "会話を選択",
    ...
    crossNotebookDiscovery: "ノートブック横断検索",
    scientificDatabases: "科学データベース",
    researchSkills: "研究手法",
    researchSkillsAuto: "研究手法：自動",
    researchSkillsOff: "研究手法：オフ",
    researchSkillsSelected: "研究手法：{count} 件選択",
    researchSkillsChoose: "最大 3 件の手法を選択",
    researchSkillsLimit: "選択した手法は今回のリクエストのみ適用され、自動モードは最大 2 件を読み込みます。",
    researchSkillNames: {
      literatureDoiVerification: "文献検索と DOI 検証",
      evidenceCriticalAppraisal: "エビデンス評価と論文批判",
      competingHypotheses: "仮説生成と競合仮説",
      doeStatisticalPlan: "DOE と統計解析計画",
      chemicalIdentityProperties: "化学物質の同定と物性検証",
      formulationCompatibilityMatrix: "処方適合性リスクマトリクス",
      hthpBrineValidation: "高温高圧・塩水検証設計",
      scaleUpValidationGates: "スケールアップリスクと検証ゲート",
      structuredResearchReport: "科学報告書の構造化執筆",
      oilwellCementAdditiveDiagnosis: "油井セメント添加剤の異常診断",
    },
    progressWorking: "実行中",
    progressReceived: "質問を受け付けました",
    progressPreparingContext: "選択した資料を準備中",
    progressContextReady: "会話資料の準備が完了しました",
    progressPlanning: "質問を分析してツールを選択中",
    progressInspectingScope: "調査範囲を確認中",
    progressSearchingNotebook: "このノートブックを検索中",
    progressReadingEvidence: "関連する根拠を確認中",
    progressSearchingCrossNotebook: "ノートブックを横断検索中",
    progressSearchingWeb: "ウェブを検索中",
    progressInspectingScientificDatabases: "利用可能な科学データベースを確認中",
    progressSearchingScientificDatabases: "科学データベースを検索中",
    progressReadingScientificRecord: "科学データベースのレコードを確認中",
    progressLoadingResearchSkills: "研究手法を読み込み中",
    progressUsingResearchTool: "調査ツールを実行中",
    progressAwaitingModel: "モデルの応答を待機中",
    progressSynthesizing: "根拠を比較して結論を整理中",
    progressModelStreaming: "回答を生成中",
    progressCompleteSummary: "{count} ステップを {seconds} 秒で完了",
    progressErrorSummary: "{seconds} 秒後にエラーで停止しました",
    progressCancelledSummary: "{seconds} 秒後に停止しました",
    progressExpand: "実行過程を展開",
    progressCollapse: "実行過程を折りたたむ",
  ...
  searchPage: {
    ...
    askProgressTitle: "質問を受け付けました。処理しています",
    askProgressComplete: "回答が完了しました",
    askProgressError: "処理中に問題が発生しました",
    askProgressCancelled: "処理を停止しました",
    askProgressElapsed: "{seconds}秒経過",
    askProgressNote: "幅広い質問では、計画、検索、読解、要約が必要なため時間がかかることがあります。",
    askProgressReceivedTitle: "受信",
    askProgressReceivedDesc: "質問とモデル設定を確認しました。",
    askProgressPlanningTitle: "計画",
    askProgressPlanningDesc: "探すべき資料を判断しています。",
    askProgressSearchingTitle: "検索",
    askProgressSearchingDesc: "知識ベースを検索し、関連する根拠を読んでいます。",
    askProgressWritingTitle: "執筆",
    askProgressWritingDesc: "根拠を統合して最終回答を作成しています。",
    coverageTitle: "検索カバレッジ",
    totalSources: "総ソース数",
    embeddedSources: "検索可能なソース",
    retrievedSources: "この質問で取得したソース",
    askHistory: "質問履歴",
    noAskHistory: "質問履歴はまだありません。",
    restoreHistory: "復元",
    clearAskHistory: "履歴を消去",
  },
  podcasts: {
  ...
  settings: {
    ...
    filesHelp: "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはLuminaがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
    ...
    redaction: {
      title: "コンテンツマスキング（外部送信保護）",
      description: "外部 AI モデルへ送信する前に機密語を自動置換し、返信結果は自動復元します。保存データと検索には影響しません",
      enableLabel: "外部送信マスキングを有効化",
      enableHelp: "有効にすると、外部 LLM へ送信するテキスト内の辞書登録語が自動的に別名に置換され、応答は UI 上で自動復元されます。保存データと検索は常に元のテキストを使用します。",
      dictTitle: "マスキング辞書",
      dictHelp: "機密語と置換別名の対応を管理します。同じ語は常に同じ別名を使用します。坑井番号・製品コード・電話番号は自動検出されます。人名などは手動で追加してください。",
      original: "機密語（原文）",
      originalPlaceholder: "例：人名・会社名など",
      alias: "置換別名",
      aliasPlaceholder: "例：エンジニアA",
      category: "カテゴリ",
      categories: {
        company: "会社名",
        address: "住所",
      ...
      addRule: "追加",
      deleteRule: "削除",
      noRules: "辞書エントリはまだありません",
      deleteConfirmTitle: "辞書エントリを削除",
      deleteConfirmDescription: "「{original}」を削除しますか？削除後、この語は自動置換されなくなります。",
      ruleAdded: "辞書エントリを追加しました",
      ruleUpdated: "辞書エントリを更新しました",
      ruleDeleted: "辞書エントリを削除しました",
    },
  },
  advanced: {
    title: "詳細ツール",
    ...
    updateAvailableDesc: "Luminaの新しいバージョンが利用可能です。",
    upToDate: "最新版です",
    unknown: "不明",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Lumina全体で異なる目的に使用するモデルを設定",
    missingRequiredModels: "必須モデルがありません: {models}。これらがないとLuminaが正しく機能しない可能性があります。",
    ...
    contextOnDemand: "オンデマンド検索。コンテキストは研究ステップごとに変化します",
    contextEstimated: "推定",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "コンテキスト上限が未設定です",
    contextProgressLabel: "モデルコンテキスト使用量: {percent}%",
    contextPending: "次の質問を送信すると使用量が更新されます",
    editContextWindow: "コンテキストウィンドウを編集",
    contextWindowDialogTitle: "モデルのコンテキストウィンドウ",
    contextWindowDialogDesc: "{model} の最大コンテキストウィンドウを設定します。",
    contextWindowTokensLabel: "コンテキストウィンドウ（トークン）",
  ...
  apiKeys: {
    ...
    description: "APIキーをデータベースに安全に保存し、LuminaでAIプロバイダーを有効にします。",
