...
export const zhTW = {
  ...
  sources: {
    ...
    downloadMarkdownPackage: "下載 Markdown + 圖片",
    moreActions: "更多操作",
    ...
    selectMultipleFilesHint: "選擇多個檔案進行批次導入。支援：文件 (PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, XLSM, EPUB, TXT, MD)",
    selectedFiles: "已選擇檔案：",
    ...
    continuingDuplicateUpload: "確認繼續上傳，準備提交...",
  },
  chat: {
    newSession: "新會話",
    selectSession: "選擇會話",
    ...
    crossNotebookDiscovery: "跨筆記本探索",
    scientificDatabases: "科研資料庫",
    researchSkills: "科研方法",
    researchSkillsAuto: "科研方法：自動",
    researchSkillsOff: "科研方法：關閉",
    researchSkillsSelected: "科研方法：已選 {count} 個",
    researchSkillsChoose: "最多選擇 3 個方法",
    researchSkillsLimit: "明確選擇的方法僅用於本次請求；自動模式最多載入 2 個。",
    researchSkillNames: {
      literatureDoiVerification: "文獻檢索與 DOI 核驗",
      evidenceCriticalAppraisal: "證據分級與論文批判",
      competingHypotheses: "假設生成與競爭性假設",
      doeStatisticalPlan: "DOE 與統計分析計畫",
      chemicalIdentityProperties: "化學身份與性質核驗",
      formulationCompatibilityMatrix: "配方相容性風險矩陣",
      hthpBrineValidation: "高溫高壓與鹽水驗證設計",
      scaleUpValidationGates: "放大風險與驗證 Gate",
      structuredResearchReport: "科研報告結構化寫作",
      oilwellCementAdditiveDiagnosis: "油井水泥外加劑異常診斷",
    },
    progressWorking: "正在執行",
    progressReceived: "已接收問題",
    progressPreparingContext: "正在準備已選資料",
    progressContextReady: "已準備對話資料",
    progressPlanning: "正在分析問題並選擇工具",
    progressInspectingScope: "正在確認研究範圍",
    progressSearchingNotebook: "正在檢索目前筆記本",
    progressReadingEvidence: "正在閱讀相關證據",
    progressSearchingCrossNotebook: "正在跨筆記本探索",
    progressSearchingWeb: "正在連網檢索",
    progressInspectingScientificDatabases: "正在確認可用科研資料庫",
    progressSearchingScientificDatabases: "正在檢索科研資料庫",
    progressReadingScientificRecord: "正在讀取科研資料庫記錄",
    progressLoadingResearchSkills: "正在載入科研方法",
    progressUsingResearchTool: "正在呼叫研究工具",
    progressAwaitingModel: "正在等待模型回應",
    progressSynthesizing: "正在比較證據並組織結論",
    progressModelStreaming: "正在產生回答",
    progressCompleteSummary: "已完成 {count} 個步驟，用時 {seconds} 秒",
    progressErrorSummary: "執行失敗，用時 {seconds} 秒",
    progressCancelledSummary: "已停止，用時 {seconds} 秒",
    progressExpand: "展開執行過程",
    progressCollapse: "收起執行過程",
  ...
  searchPage: {
    ...
    askProgressTitle: "已收到問題，正在處理",
    askProgressComplete: "回答已完成",
    askProgressError: "處理時遇到問題",
    askProgressCancelled: "已停止處理",
    askProgressElapsed: "已用 {seconds}s",
    askProgressNote: "較寬泛的問題需要規劃、檢索、閱讀和綜合，可能需要多等一會兒。",
    askProgressReceivedTitle: "收到問題",
    askProgressReceivedDesc: "已確認問題和模型設定。",
    askProgressPlanningTitle: "規劃檢索",
    askProgressPlanningDesc: "正在判斷需要查找哪些資料。",
    askProgressSearchingTitle: "檢索閱讀",
    askProgressSearchingDesc: "正在搜尋知識庫並提取相關證據。",
    askProgressWritingTitle: "撰寫答案",
    askProgressWritingDesc: "正在綜合證據並生成最終回答。",
    coverageTitle: "檢索覆蓋範圍",
    totalSources: "來源總數",
    embeddedSources: "可檢索來源",
    retrievedSources: "本次命中來源",
    askHistory: "提問歷史",
    noAskHistory: "暫無提問歷史。",
    restoreHistory: "恢復",
    clearAskHistory: "清空提問歷史",
  },
  podcasts: {
  ...
  settings: {
    ...
    redaction: {
      title: "內容脫敏（出網防護）",
      description: "資料送往外部 AI 模型前自動替換敏感詞，回傳結果自動還原；庫內原文與搜尋不受影響",
      enableLabel: "啟用出網脫敏",
      enableHelp: "開啟後，送往外部大模型的內容將自動把詞典中的敏感詞替換為代號，模型回傳後在介面自動還原。庫內儲存與搜尋始終使用原文，不受影響。",
      dictTitle: "脫敏詞典",
      dictHelp: "維護敏感詞與替換代號的對照。同一敏感詞全程使用同一代號；井號、產品代號、電話號碼可自動識別，人名等請手動新增。",
      original: "敏感詞（原文）",
      originalPlaceholder: "如：張三 / 歐美克 / 寧218-1井",
      alias: "替換代號",
      aliasPlaceholder: "如：工程師A / 某企業 / 實驗井A",
      category: "類別",
      categories: {
        company: "公司名稱",
        address: "地址資訊",
      ...
      deleteRule: "刪除",
      noRules: "暫無詞典條目",
      deleteConfirmTitle: "刪除詞典條目",
      deleteConfirmDescription: "確定要刪除「{original}」嗎？刪除後該敏感詞將不再被自動替換。",
      ruleAdded: "詞典條目已新增",
      ruleUpdated: "詞典條目已更新",
      ruleDeleted: "詞典條目已刪除",
    },
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 Lumina 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，Lumina 可能無法正常運行。",
    ...
    contextOnDemand: "按需檢索模式；上下文會隨研究步驟動態變化",
    contextEstimated: "估算",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "未設定上下文上限",
    contextProgressLabel: "模型上下文用量：{percent}%",
    contextPending: "傳送下一個問題後更新用量",
    editContextWindow: "編輯上下文視窗",
    contextWindowDialogTitle: "模型上下文視窗",
    contextWindowDialogDesc: "設定 {model} 的最大上下文視窗。",
    contextWindowTokensLabel: "上下文視窗（詞元）",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 Lumina 中啟用 AI 服務商。",
