...
export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Lumina non è raggiungibile",
  ...
  sources: {
    ...
    downloadMarkdownPackage: "Scarica Markdown + immagini",
    ...
    selectMultipleFilesHint: "Seleziona più file per importazione batch. Supportati: Documenti (PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, XLSM, EPUB, TXT, MD)",
    ...
    continuingDuplicateUpload: "Caricamento in corso...",
  },
  chat: {
    ...
    exportAssistantLabel: "Assistente",
    sessions: "Sessioni",
    ...
    crossNotebookDiscovery: "Ricerca tra notebook",
    scientificDatabases: "Banche dati scientifiche",
    researchSkills: "Metodi di ricerca",
    researchSkillsAuto: "Metodi: automatico",
    researchSkillsOff: "Metodi: disattivati",
    researchSkillsSelected: "Metodi: {count} selezionati",
    researchSkillsChoose: "Scegli fino a 3 metodi",
    researchSkillsLimit: "I metodi selezionati valgono solo per questa richiesta; la modalità automatica ne carica fino a 2.",
    researchSkillNames: {
      literatureDoiVerification: "Ricerca bibliografica e verifica DOI",
      evidenceCriticalAppraisal: "Valutazione delle prove e analisi critica",
      competingHypotheses: "Generazione e confronto di ipotesi",
      doeStatisticalPlan: "DOE e piano di analisi statistica",
      chemicalIdentityProperties: "Identità chimica e verifica delle proprietà",
      formulationCompatibilityMatrix: "Matrice dei rischi di compatibilità della formulazione",
      hthpBrineValidation: "Progettazione della convalida HTHP e salamoia",
      scaleUpValidationGates: "Rischi di scale-up e gate di convalida",
      structuredResearchReport: "Scrittura strutturata del rapporto scientifico",
      oilwellCementAdditiveDiagnosis: "Diagnosi degli additivi per cemento da pozzo",
    },
    progressWorking: "Elaborazione in corso",
    progressReceived: "Domanda ricevuta",
    progressPreparingContext: "Preparazione del materiale selezionato",
    progressContextReady: "Materiale della conversazione pronto",
    progressPlanning: "Analisi della domanda e selezione degli strumenti",
    progressInspectingScope: "Verifica dell'ambito di ricerca",
    progressSearchingNotebook: "Ricerca in questo notebook",
    progressReadingEvidence: "Lettura delle prove pertinenti",
    progressSearchingCrossNotebook: "Ricerca tra notebook",
    progressSearchingWeb: "Ricerca sul Web",
    progressInspectingScientificDatabases: "Verifica delle banche dati scientifiche disponibili",
    progressSearchingScientificDatabases: "Ricerca nelle banche dati scientifiche",
    progressReadingScientificRecord: "Lettura di un record scientifico",
    progressLoadingResearchSkills: "Caricamento dei metodi di ricerca",
    progressUsingResearchTool: "Esecuzione di uno strumento di ricerca",
    progressAwaitingModel: "In attesa della risposta del modello",
    progressSynthesizing: "Confronto delle prove e organizzazione dei risultati",
    progressModelStreaming: "Generazione della risposta",
    progressCompleteSummary: "{count} passaggi completati in {seconds} s",
    progressErrorSummary: "Interrotto con errore dopo {seconds} s",
    progressCancelledSummary: "Interrotto dopo {seconds} s",
    progressExpand: "Espandi attività",
    progressCollapse: "Comprimi attività",
  ...
  searchPage: {
    ...
    askBeta: "Chiedi",
    search: "Cerca",
    askYourKb: "Chiedi alla tua base di conoscenza",
    ...
    askProgressTitle: "Domanda ricevuta, elaborazione in corso",
    askProgressComplete: "Risposta completata",
    askProgressError: "Si è verificato un problema durante l'elaborazione",
    askProgressCancelled: "Elaborazione interrotta",
    askProgressElapsed: "{seconds}s trascorsi",
    askProgressNote: "Le domande ampie possono richiedere più tempo perché Ask deve pianificare, recuperare, leggere e riassumere.",
    askProgressReceivedTitle: "Ricevuta",
    askProgressReceivedDesc: "Domanda e impostazioni dei modelli confermate.",
    askProgressPlanningTitle: "Pianificazione",
    askProgressPlanningDesc: "Scelta dei materiali da cercare.",
    askProgressSearchingTitle: "Ricerca",
    askProgressSearchingDesc: "Ricerca nella base di conoscenza e lettura delle evidenze rilevanti.",
    askProgressWritingTitle: "Scrittura",
    askProgressWritingDesc: "Sintesi delle evidenze nella risposta finale.",
    coverageTitle: "Copertura del recupero",
    totalSources: "Fonti totali",
    embeddedSources: "Fonti ricercabili",
    retrievedSources: "Fonti trovate per questa domanda",
    askHistory: "Cronologia domande",
    noAskHistory: "Nessuna cronologia domande al momento.",
    restoreHistory: "Ripristina",
    clearAskHistory: "Cancella cronologia",
  },
  podcasts: {
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Lumina di eliminare automaticamente i file caricati dalla cartella upload.",
    ...
    redaction: {
      title: "Oscuramento Contenuti (Protezione in Uscita)",
      description: "I termini sensibili vengono sostituiti prima dell'invio ai provider AI esterni e ripristinati al ritorno; i contenuti archiviati restano invariati",
      enableLabel: "Attiva oscuramento in uscita",
      enableHelp: "Se attivo, i prompt inviati ai LLM esterni sostituiscono i termini del dizionario con alias e le risposte vengono ripristinate automaticamente nell'interfaccia. Contenuti archiviati e ricerca usano sempre il testo originale.",
      dictTitle: "Dizionario di Oscuramento",
      dictHelp: "Gestisci la mappatura termine sensibile -> alias. Ogni termine mantiene un alias stabile per sempre; pozzi, codici prodotto e numeri di telefono vengono rilevati automaticamente - aggiungi i nomi manualmente.",
      original: "Termine sensibile",
      originalPlaceholder: "es. nome di persona o azienda",
      alias: "Alias",
      aliasPlaceholder: "es. Ingegnere A",
      category: "Categoria",
      categories: {
        company: "Azienda",
        address: "Indirizzo",
      ...
      addRule: "Aggiungi",
      deleteRule: "Elimina",
      noRules: "Nessuna voce nel dizionario",
      deleteConfirmTitle: "Elimina voce",
      deleteConfirmDescription: "Eliminare '{original}'? Il termine non verrà più sostituito automaticamente.",
      ruleAdded: "Voce aggiunta",
      ruleUpdated: "Voce aggiornata",
      ruleDeleted: "Voce eliminata",
    },
  },
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Lumina.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Lumina",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. Lumina potrebbe non funzionare correttamente senza questi.",
    ...
    contextOnDemand: "Recupero su richiesta; il contesto cambia durante ogni fase di ricerca",
    contextEstimated: "stimato",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "Limite del contesto non configurato",
    contextProgressLabel: "Utilizzo del contesto del modello: {percent}%",
    contextPending: "L'utilizzo si aggiorna dopo la prossima domanda",
    editContextWindow: "Modifica finestra di contesto",
    contextWindowDialogTitle: "Finestra di contesto del modello",
    contextWindowDialogDesc: "Imposta la finestra di contesto massima per {model}.",
    contextWindowTokensLabel: "Finestra di contesto (token)",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Lumina.",
