...
export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Lumina est injoignable",
    ...
    docLink: "Documentation de Lumina",
  ...
  sources: {
    ...
    downloadMarkdownPackage: "Télécharger Markdown + images",
    ...
    selectMultipleFilesHint: "Sélectionnez plusieurs fichiers pour une importation groupée. Supportés : Documents (PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, XLSM, EPUB, TXT, MD)",
    ...
    continuingDuplicateUpload: "Poursuite de l'import...",
  },
  chat: {
    ...
    crossNotebookDiscovery: "Recherche inter-carnets",
    scientificDatabases: "Bases de données scientifiques",
    researchSkills: "Méthodes de recherche",
    researchSkillsAuto: "Méthodes : auto",
    researchSkillsOff: "Méthodes : désactivées",
    researchSkillsSelected: "Méthodes : {count} sélectionnées",
    researchSkillsChoose: "Choisir jusqu'à 3 méthodes",
    researchSkillsLimit: "Les méthodes choisies ne s'appliquent qu'à cette requête ; le mode auto en charge jusqu'à 2.",
    researchSkillNames: {
      literatureDoiVerification: "Recherche bibliographique et vérification du DOI",
      evidenceCriticalAppraisal: "Niveau de preuve et analyse critique",
      competingHypotheses: "Génération et comparaison d'hypothèses",
      doeStatisticalPlan: "Plan d'expériences et analyse statistique",
      chemicalIdentityProperties: "Identité chimique et vérification des propriétés",
      formulationCompatibilityMatrix: "Matrice de risque de compatibilité des formulations",
      hthpBrineValidation: "Validation HTHP et saumure",
      scaleUpValidationGates: "Risques de mise à l'échelle et jalons",
      structuredResearchReport: "Rédaction structurée du rapport scientifique",
      oilwellCementAdditiveDiagnosis: "Diagnostic des additifs pour ciment de puits",
    },
    progressWorking: "Traitement en cours",
    progressReceived: "Question reçue",
    progressPreparingContext: "Préparation des documents sélectionnés",
    progressContextReady: "Documents de conversation prêts",
    progressPlanning: "Analyse de la question et sélection des outils",
    progressInspectingScope: "Vérification du périmètre de recherche",
    progressSearchingNotebook: "Recherche dans ce carnet",
    progressReadingEvidence: "Lecture des éléments pertinents",
    progressSearchingCrossNotebook: "Recherche dans les autres carnets",
    progressSearchingWeb: "Recherche sur le Web",
    progressInspectingScientificDatabases: "Vérification des bases scientifiques disponibles",
    progressSearchingScientificDatabases: "Recherche dans les bases scientifiques",
    progressReadingScientificRecord: "Lecture d'une notice scientifique",
    progressLoadingResearchSkills: "Chargement des méthodes de recherche",
    progressUsingResearchTool: "Exécution d'un outil de recherche",
    progressAwaitingModel: "Attente de la réponse du modèle",
    progressSynthesizing: "Comparaison des éléments et organisation des conclusions",
    progressModelStreaming: "Rédaction de la réponse",
    progressCompleteSummary: "{count} étapes terminées en {seconds} s",
    progressErrorSummary: "Arrêt sur erreur après {seconds} s",
    progressCancelledSummary: "Arrêt après {seconds} s",
    progressExpand: "Développer l'activité",
    progressCollapse: "Réduire l'activité",
  ...
  searchPage: {
    ...
    askBeta: "Demander",
    search: "Recherche",
    askYourKb: "Interroger votre base de connaissances",
    ...
    askProgressTitle: "Question reçue, traitement en cours",
    askProgressComplete: "Réponse terminée",
    askProgressError: "Un problème est survenu pendant le traitement",
    askProgressCancelled: "Traitement arrêté",
    askProgressElapsed: "{seconds}s écoulées",
    askProgressNote: "Les questions larges peuvent prendre plus de temps car Ask doit planifier, récupérer, lire et résumer.",
    askProgressReceivedTitle: "Reçue",
    askProgressReceivedDesc: "Question et modèles confirmés.",
    askProgressPlanningTitle: "Planification",
    askProgressPlanningDesc: "Détermination des documents à rechercher.",
    askProgressSearchingTitle: "Recherche",
    askProgressSearchingDesc: "Recherche dans la base de connaissances et lecture des preuves pertinentes.",
    askProgressWritingTitle: "Rédaction",
    askProgressWritingDesc: "Synthèse des preuves dans la réponse finale.",
    coverageTitle: "Couverture de récupération",
    totalSources: "Sources totales",
    embeddedSources: "Sources consultables",
    retrievedSources: "Sources trouvées pour cette question",
    askHistory: "Historique des questions",
    noAskHistory: "Aucun historique de question pour le moment.",
    restoreHistory: "Restaurer",
    clearAskHistory: "Effacer l'historique",
  },
  podcasts: {
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Lumina à supprimer automatiquement les fichiers du dossier de téléchargement.",
    ...
    redaction: {
      title: "Masquage de Contenu (Protection Sortante)",
      description: "Les termes sensibles sont remplacés avant l'envoi aux fournisseurs d'IA externes et restaurés au retour ; le contenu stocké reste intact",
      enableLabel: "Activer le masquage sortant",
      enableHelp: "Une fois activé, les prompts envoyés aux LLM externes remplacent les termes du dictionnaire par des alias, et les réponses sont automatiquement restaurées dans l'interface. Le contenu stocké et la recherche utilisent toujours le texte original.",
      dictTitle: "Dictionnaire de Masquage",
      dictHelp: "Gérez la correspondance terme sensible -> alias. Chaque terme conserve un alias stable ; puits, codes produits et téléphones sont détectés automatiquement - ajoutez les noms manuellement.",
      original: "Terme sensible",
      originalPlaceholder: "ex. nom de personne ou d'entreprise",
      alias: "Alias",
      aliasPlaceholder: "ex. Ingénieur A",
      category: "Catégorie",
      categories: {
        company: "Entreprise",
        address: "Adresse",
      ...
      noRules: "Aucune entrée dans le dictionnaire",
      deleteConfirmTitle: "Supprimer l'entrée",
      deleteConfirmDescription: "Supprimer « {original} » ? Ce terme ne sera plus remplacé automatiquement.",
      ruleAdded: "Entrée ajoutée",
      ruleUpdated: "Entrée mise à jour",
      ruleDeleted: "Entrée supprimée",
    },
  },
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Lumina est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Lumina",
    missingRequiredModels: "Modèles requis manquants : {models}. Lumina pourrait ne pas fonctionner correctement sans eux.",
    ...
    contextOnDemand: "Recherche à la demande ; le contexte évolue à chaque étape de recherche",
    contextEstimated: "estimé",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "Limite de contexte non configurée",
    contextProgressLabel: "Utilisation du contexte du modèle : {percent}%",
    contextPending: "L'utilisation sera actualisée après la prochaine question",
    editContextWindow: "Modifier la fenêtre de contexte",
    contextWindowDialogTitle: "Fenêtre de contexte du modèle",
    contextWindowDialogDesc: "Définissez la fenêtre de contexte maximale pour {model}.",
    contextWindowTokensLabel: "Fenêtre de contexte (jetons)",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Lumina.",
