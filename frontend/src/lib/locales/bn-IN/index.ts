...
export const bnIN = {
  ...
  sources: {
    ...
    downloadMarkdown: "Markdown ডাউনলোড করুন",
    downloadMarkdownPackage: "Markdown + ছবি ডাউনলোড করুন",
    moreActions: "আরও কাজ",
    ...
    selectMultipleFilesHint: "ব্যাচ ইমপোর্টের জন্য একাধিক ফাইল নির্বাচন করুন। সমর্থিত: ডকুমেন্ট (PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, XLSM, EPUB, TXT, MD)",
    ...
    backToSources: "উৎসগুলিতে ফিরে যান",
    ...
    continuingDuplicateUpload: "আপলোড চালিয়ে যাওয়া হচ্ছে...",
  },
  chat: {
    newSession: "নতুন কথোপকথন",
    ...
    exportUserLabel: "ব্যবহারকারী",
    exportAssistantLabel: "সহায়ক",
    sessions: "সেশনগুলি",
    ...
    quickChat: "দ্রুত চ্যাট",
    researchAgent: "Research Agent",
    crossNotebookDiscovery: "নোটবুক জুড়ে অনুসন্ধান",
    scientificDatabases: "বৈজ্ঞানিক ডেটাবেস",
    researchSkills: "গবেষণা পদ্ধতি",
    researchSkillsAuto: "পদ্ধতি: স্বয়ংক্রিয়",
    researchSkillsOff: "পদ্ধতি: বন্ধ",
    researchSkillsSelected: "পদ্ধতি: {count}টি নির্বাচিত",
    researchSkillsChoose: "সর্বোচ্চ ৩টি পদ্ধতি বেছে নিন",
    researchSkillsLimit: "নির্বাচিত পদ্ধতি শুধু এই অনুরোধে প্রযোজ্য; স্বয়ংক্রিয় মোড সর্বোচ্চ ২টি লোড করে।",
    researchSkillNames: {
      literatureDoiVerification: "সাহিত্য অনুসন্ধান ও DOI যাচাই",
      evidenceCriticalAppraisal: "প্রমাণের মান ও সমালোচনামূলক মূল্যায়ন",
      competingHypotheses: "অনুমান তৈরি ও তুলনা",
      doeStatisticalPlan: "DOE ও পরিসংখ্যান বিশ্লেষণ পরিকল্পনা",
      chemicalIdentityProperties: "রাসায়নিক পরিচয় ও বৈশিষ্ট্য যাচাই",
      formulationCompatibilityMatrix: "ফর্মুলেশন সামঞ্জস্য ঝুঁকি ম্যাট্রিক্স",
      hthpBrineValidation: "HTHP ও ব্রাইন যাচাই নকশা",
      scaleUpValidationGates: "স্কেল-আপ ঝুঁকি ও যাচাই গেট",
      structuredResearchReport: "কাঠামোবদ্ধ গবেষণা প্রতিবেদন",
      oilwellCementAdditiveDiagnosis: "তেলকূপ সিমেন্ট অ্যাডিটিভ নির্ণয়",
    },
    progressWorking: "কাজ চলছে",
    progressReceived: "প্রশ্ন গ্রহণ করা হয়েছে",
    progressPreparingContext: "নির্বাচিত উপাদান প্রস্তুত করা হচ্ছে",
    progressContextReady: "কথোপকথনের উপাদান প্রস্তুত",
    progressPlanning: "প্রশ্ন বিশ্লেষণ ও টুল নির্বাচন করা হচ্ছে",
    progressInspectingScope: "গবেষণার পরিধি যাচাই করা হচ্ছে",
    progressSearchingNotebook: "এই নোটবুকে অনুসন্ধান করা হচ্ছে",
    progressReadingEvidence: "প্রাসঙ্গিক প্রমাণ পড়া হচ্ছে",
    progressSearchingCrossNotebook: "নোটবুক জুড়ে অনুসন্ধান করা হচ্ছে",
    progressSearchingWeb: "ওয়েবে অনুসন্ধান করা হচ্ছে",
    progressInspectingScientificDatabases: "উপলভ্য বৈজ্ঞানিক ডেটাবেস যাচাই করা হচ্ছে",
    progressSearchingScientificDatabases: "বৈজ্ঞানিক ডেটাবেসে অনুসন্ধান করা হচ্ছে",
    progressReadingScientificRecord: "বৈজ্ঞানিক ডেটাবেস রেকর্ড পড়া হচ্ছে",
    progressLoadingResearchSkills: "গবেষণা পদ্ধতি লোড হচ্ছে",
    progressUsingResearchTool: "গবেষণা টুল চালানো হচ্ছে",
    progressAwaitingModel: "মডেলের উত্তরের অপেক্ষা করা হচ্ছে",
    progressSynthesizing: "প্রমাণ তুলনা ও ফলাফল সাজানো হচ্ছে",
    progressModelStreaming: "উত্তর লেখা হচ্ছে",
    progressCompleteSummary: "{seconds} সেকেন্ডে {count}টি ধাপ সম্পন্ন",
    progressErrorSummary: "{seconds} সেকেন্ড পরে ত্রুটির কারণে বন্ধ হয়েছে",
    progressCancelledSummary: "{seconds} সেকেন্ড পরে বন্ধ হয়েছে",
    progressExpand: "কার্যক্রম প্রসারিত করুন",
    progressCollapse: "কার্যক্রম সংকুচিত করুন",
  ...
  searchPage: {
    ...
    askBeta: "জিজ্ঞাসা",
    search: "অনুসন্ধান",
    askYourKb: "আপনার জ্ঞানভান্ডার জিজ্ঞাসা করুন",
    ...
    askProgressTitle: "প্রশ্ন পাওয়া গেছে, কাজ চলছে",
    askProgressComplete: "উত্তর সম্পূর্ণ",
    askProgressError: "প্রক্রিয়াকরণের সময় সমস্যা হয়েছে",
    askProgressCancelled: "প্রক্রিয়াকরণ বন্ধ করা হয়েছে",
    askProgressElapsed: "{seconds}s অতিবাহিত",
    askProgressNote: "বিস্তৃত প্রশ্নে পরিকল্পনা, অনুসন্ধান, পড়া এবং সারসংক্ষেপ করতে বেশি সময় লাগতে পারে।",
    askProgressReceivedTitle: "পাওয়া গেছে",
    askProgressReceivedDesc: "প্রশ্ন এবং মডেল সেটিংস নিশ্চিত করা হয়েছে।",
    askProgressPlanningTitle: "পরিকল্পনা",
    askProgressPlanningDesc: "কোন উপকরণ খুঁজতে হবে তা নির্ধারণ করা হচ্ছে।",
    askProgressSearchingTitle: "অনুসন্ধান",
    askProgressSearchingDesc: "জ্ঞানভাণ্ডার অনুসন্ধান এবং প্রাসঙ্গিক প্রমাণ পড়া হচ্ছে।",
    askProgressWritingTitle: "লেখা",
    askProgressWritingDesc: "প্রমাণ মিলিয়ে চূড়ান্ত উত্তর তৈরি করা হচ্ছে।",
    coverageTitle: "পুনরুদ্ধার কভারেজ",
    totalSources: "মোট উৎস",
    embeddedSources: "অনুসন্ধানযোগ্য উৎস",
    retrievedSources: "এই প্রশ্নে পাওয়া উৎস",
    askHistory: "প্রশ্নের ইতিহাস",
    noAskHistory: "এখনও কোনো প্রশ্নের ইতিহাস নেই।",
    restoreHistory: "পুনরুদ্ধার",
    clearAskHistory: "ইতিহাস মুছুন",
  },
  podcasts: {
  ...
  settings: {
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী Lumina কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
    ...
    redaction: {
      title: "কনটেন্ট মাস্কিং (বাহ্যিক সুরক্ষা)",
      description: "বাইরের AI প্রোভাইডারে পাঠানোর আগে সংবেদনশীল শব্দ স্বয়ংক্রিয়ভাবে প্রতিস্থাপিত হয় এবং ফেরত আসার পর পুনরুদ্ধার হয়; সংরক্ষিত ডেটা অপরিবর্তিত থাকে",
      enableLabel: "বাহ্যিক মাস্কিং সক্রিয় করুন",
      enableHelp: "সক্রিয় হলে বাইরের LLM-এ পাঠানো প্রম্পটে অভিধানের শব্দগুলি উপনামে প্রতিস্থাপিত হবে এবং উত্তর ইন্টারফেসে স্বয়ংক্রিয়ভাবে পুনরুদ্ধার হবে। সংরক্ষিত ডেটা ও অনুসন্ধান সর্বদা মূল টেক্সট ব্যবহার করে।",
      dictTitle: "মাস্কিং অভিধান",
      dictHelp: "সংবেদনশীল শব্দ ও উপনামের ম্যাপিং পরিচালনা করুন। প্রতিটি শব্দ চিরকাল একটিই উপনাম ব্যবহার করে; কুয়া, পণ্য কোড ও ফোন নম্বর স্বয়ংক্রিয়ভাবে শনাক্ত হয় - নাম ম্যানুয়ালি যোগ করুন।",
      original: "সংবেদনশীল শব্দ",
      originalPlaceholder: "যেমন ব্যক্তি বা কোম্পানির নাম",
      alias: "উপনাম",
      aliasPlaceholder: "যেমন ইঞ্জিনিয়ার A",
      category: "শ্রেণি",
      categories: {
        company: "কোম্পানি",
        address: "ঠিকানা",
      ...
      source: "উৎস",
      autoSource: "স্বয়ংক্রিয়",
      manualSource: "ম্যানুয়াল",
      status: "অবস্থা",
      enabledLabel: "সক্রিয়",
      disabledLabel: "নিষ্ক্রিয়",
      addRule: "যোগ করুন",
      deleteRule: "মুছুন",
      noRules: "অভিধানে কোনো এন্ট্রি নেই",
      deleteConfirmTitle: "এন্ট্রি মুছুন",
      deleteConfirmDescription: "'{original}' মুছবেন? এই শব্দটি আর স্বয়ংক্রিয়ভাবে প্রতিস্থাপিত হবে না।",
      ruleAdded: "এন্ট্রি যোগ হয়েছে",
      ruleUpdated: "এন্ট্রি আপডেট হয়েছে",
      ruleDeleted: "এন্ট্রি মুছে ফেলা হয়েছে",
    },
  },
  advanced: {
    title: "উন্নত টুলস",
    ...
    updateAvailableDesc: "Lumina এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Lumina জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {models}। এগুলি ছাড়া Lumina সঠিকভাবে কাজ নাও করতে পারে।",
    ...
    contextOnDemand: "চাহিদাভিত্তিক অনুসন্ধান; প্রতিটি গবেষণা ধাপে কনটেক্সট পরিবর্তিত হয়",
    contextEstimated: "আনুমানিক",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "কনটেক্সট সীমা কনফিগার করা নেই",
    contextProgressLabel: "মডেল কনটেক্সট ব্যবহার: {percent}%",
    contextPending: "পরবর্তী প্রশ্ন পাঠানোর পরে ব্যবহার আপডেট হবে",
    editContextWindow: "কনটেক্সট উইন্ডো সম্পাদনা করুন",
    contextWindowDialogTitle: "মডেল কনটেক্সট উইন্ডো",
    contextWindowDialogDesc: "{model}-এর সর্বোচ্চ কনটেক্সট উইন্ডো নির্ধারণ করুন।",
    contextWindowTokensLabel: "কনটেক্সট উইন্ডো (টোকেন)",
  ...
  apiKeys: {
    ...
    description: "Lumina এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
