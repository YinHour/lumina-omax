export const zhCN = {
  ...
  auth: {
    ...
    usernamePlaceholder: "请输入您的用户名 (默认为 admin)",
    password: "密码",
    enterPlatform: "进入科研平台",
    platformTagline: "Lumiton·Omax 科研数据中台",
    tabLogin: "用户登录",
    tabRegister: "申请注册",
    regUsername: "申请登录用户名",
    regUsernamePlaceholder: "例：zhangsan",
    regDisplayName: "真实姓名 / 科研昵称",
    regDisplayNamePlaceholder: "例：张三 (水泥工程组)",
    regPassword: "设置平台密码",
    regPasswordPlaceholder: "请输入强密码",
    regConfirmPassword: "确认密码",
    regConfirmPasswordPlaceholder: "请再次输入密码",
    regAllFieldsRequired: "所有字段均为必填项",
    regPasswordMismatch: "两次输入的密码不一致",
    regSuccess: "注册申请已成功提交！您的账号当前处于待审批 (pending) 状态。请联系管理员激活账号后进行登录。",
    regFailed: "注册失败，请稍后重试",
    regNetworkError: "网络连接失败，请检查后端服务",
    regSubmitting: "正在提交申请...",
    regSubmit: "提交注册申请",
    regApprovalHint: "ℹ️ 提示：注册后需要具有 admin 权限的管理员在\"系统设置 → 成员审批\"中批准激活，方可正式登录使用。",
    signinLoading: "正在进入系统...",
    platformTitle: "科研数据中台",
    platformDesc: "油井化学智能决策与文献大模型系统",
    configVersion: "平台版本：v",
  },
  navigation: {
    collect: "采集",
    process: "处理",
  ...
  sources: {
    ...
    downloadMarkdownPackage: "下载 Markdown + 图片",
    moreActions: "更多操作",
    ...
    selectMultipleFilesHint: "选择多个文件进行批量导入。支持：文档 (PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, XLSM, EPUB, TXT, MD)",
    selectedFiles: "已选择文件：",
    ...
    addSource: "添加来源",
    batchDelete: "批量删除",
    batchDeleteConfirm: "确定要永久删除选定的 {count} 个来源吗？",
    clearSelection: "取消选择",
    itemsSelected: "已选择 {count} 项",
    batchDeleteSuccess: "成功删除 {count} 个来源",
    batchPartialSuccess: "成功删除 {success} 个，失败 {failed} 个",
    ...
    sourceLimitRemaining: "此笔记本还可添加 {remaining} 个来源（上限 {limit} 个）。",
    sourceLimitReached: "此笔记本的来源数已达到 {count} 个上限。",
    added: "已添加于 {date}",
    addUrl: "添加 URL",
    uploadFile: "上传文件",
    enterText: "输入文本",
    ...
    enterPassword: "请输入密码",
    incorrectPassword: "密码错误",
    noNewFiles: "没有上传新文件，全部为重复项",
    fileDuplicateSkipped: "该文件为重复项，已跳过",
    filteringDuplicates: "确认继续上传，过滤重复项...",
    continuingDuplicateUpload: "确认继续上传，准备提交...",
    duplicateFilesDetected: "发现同名文件",
    duplicateFilesDetectedDesc: "系统检测到以下文件可能已经上传过：",
    continueUploadQuestion: "是否继续上传？",
    cancelNo: "否 (取消)",
    onlyNonDuplicates: "仅上传非重复文件",
    uploadAll: "是 (全部上传)",
    setAllFullText: "全部设为参考全文",
    setAllInsights: "全部设为参考见解",
    setAllToOff: "全部设为不参考",
    pageOfTotal: "第 {page}/{total} 页，共 {count} 条",
    ...
    contextTokens: "{count} 词元",
    contextChars: "{count} 字符",
  },
  profile: {
    title: "个人资料",
    desc: "管理你的个人信息和账号安全",
  ...
  chat: {
    ...
    quickChat: "快速对话",
    researchAgent: "科研 Agent",
    crossNotebookDiscovery: "跨笔记本发现",
    scientificDatabases: "科研数据库",
    researchSkills: "科研方法",
    researchSkillsAuto: "科研方法：自动",
    researchSkillsOff: "科研方法：关闭",
    researchSkillsSelected: "科研方法：已选 {count} 个",
    researchSkillsChoose: "最多选择 3 个方法",
    researchSkillsLimit: "显式方法仅用于本次请求；自动模式最多加载 2 个。",
    researchSkillNames: {
      literatureDoiVerification: "文献检索与 DOI 核验",
      evidenceCriticalAppraisal: "证据分级与论文批判",
      competingHypotheses: "假设生成与竞争性假设",
      doeStatisticalPlan: "DOE 与统计分析计划",
      chemicalIdentityProperties: "化学身份与性质核验",
      formulationCompatibilityMatrix: "配方相容性风险矩阵",
      hthpBrineValidation: "高温高压与盐水验证设计",
      scaleUpValidationGates: "放大风险与验证 Gate",
      structuredResearchReport: "科研报告结构化写作",
      oilwellCementAdditiveDiagnosis: "油井水泥外加剂异常诊断",
    },
    ...
    activityModelStreaming: "模型已开始输出...",
    progressWorking: "正在执行",
    progressReceived: "已接收问题",
    progressPreparingContext: "正在准备已选资料",
    progressContextReady: "已准备对话资料",
    progressPlanning: "正在分析问题并选择工具",
    progressInspectingScope: "正在确认研究范围",
    progressSearchingNotebook: "正在检索当前笔记本",
    progressReadingEvidence: "正在阅读相关证据",
    progressSearchingCrossNotebook: "正在跨笔记本发现",
    progressSearchingWeb: "正在联网检索",
    progressInspectingScientificDatabases: "正在确认可用科研数据库",
    progressSearchingScientificDatabases: "正在检索科研数据库",
    progressReadingScientificRecord: "正在读取科研数据库记录",
    progressLoadingResearchSkills: "正在加载科研方法",
    progressUsingResearchTool: "正在调用研究工具",
    progressAwaitingModel: "正在等待模型响应",
    progressSynthesizing: "正在比较证据并组织结论",
    progressModelStreaming: "正在生成回答",
    progressCompleteSummary: "已完成 {count} 个步骤，用时 {seconds} 秒",
    progressErrorSummary: "执行失败，用时 {seconds} 秒",
    progressCancelledSummary: "已停止，用时 {seconds} 秒",
    progressExpand: "展开执行过程",
    progressCollapse: "收起执行过程",
    errorLlmTimeoutPrefix: "⚠️ 系统提示：",
    ...
    errorResearchStall: "科研 Agent 已长时间没有有效进展。\n\n系统在检测到多轮研究均无新结论后取消了本次运行。请稍后重试；如果问题范围较广，可以尝试拆分为几个更具体的问题，或减少启用的联网搜索、科研数据库等能力。",
    errorResearchHardTimeout: "科研 Agent 超过整体时间上限 {seconds} 秒。\n\n研究任务涉及多轮检索、阅读与综合，耗时较长；系统在超时后已取消本次运行。请尝试缩小问题范围，或减少启用的研究能力后重试。",
    errorAuthentication: "模型 API Key 校验失败。\n\n密钥可能已失效或被更换。请联系管理员到「设置 → API Keys」检查并更新对应供应商的凭证。",
    errorRateLimit: "模型服务暂时限流。\n\n短时间内请求过多，已被供应商拒绝。请等待 1 分钟后重试；或在对话顶部切换到其它可用模型。",
    errorConfiguration: "模型配置异常。\n\n本次请求没有找到可用的默认模型。请联系管理员到「设置 → 模型」检查默认模型与对应凭证是否正确。",
    errorNetwork: "无法连接到模型服务。\n\n请检查本机网络；如果使用的是本地模型（如 Ollama），请确认服务进程已经启动并监听端口。稍后再试一次。",
    errorExternalService: "模型供应商返回错误。\n\n通常是上游临时性问题（过载、5xx、上下文超长、请求体过大）。请稍后重试，或减少所选来源数量，或在对话顶部切换到其它模型。",
    errorInvalidInput: "请求被模型供应商拒绝。\n\n该请求可能含有不支持的格式或内容。请尝试简化问题再发送；如果反复出现，请把下方的诊断信息发给开发团队。",
    errorNotFound: "请求的资源不存在。\n\n本次请求引用的笔记本、会话或模型已被删除或不可用。请刷新页面后重试。",
    errorInternal: "回答本次问题时发生内部错误。\n\n请稍后重试。如果反复出现，请把下方的诊断信息发给开发团队以便排查。",
    errorGeneric: "本次对话请求未能完成。\n\n请稍后重试。如果反复出现，请把下方的诊断信息发给开发团队以便排查。",
    editAndAskAgain: "编辑后再问",
    generatingGuide: "正在生成结构化导览卡片...",
    generatingGuideDesc: "正在准备首个总结和下一步建议。",
    guideStepReading: "读取已选来源",
    guideStepSummarizing: "总结关键内容",
    guideStepQuestions: "生成建议动作",
  },
  searchPage: {
    askAndSearch: "提问与搜索",
    chooseAMode: "选择模式",
    ...
    askProgressTitle: "已收到问题，正在处理",
    askProgressComplete: "回答已完成",
    askProgressError: "处理时遇到问题",
    askProgressCancelled: "已停止处理",
    askProgressElapsed: "已用 {seconds}s",
    askProgressNote: "较宽泛的问题需要规划、检索、阅读和综合，可能需要多等一会儿。",
    askProgressReceivedTitle: "收到问题",
    askProgressReceivedDesc: "已确认问题和模型配置。",
    askProgressPlanningTitle: "规划检索",
    askProgressPlanningDesc: "正在判断需要查找哪些资料。",
    askProgressSearchingTitle: "检索阅读",
    askProgressSearchingDesc: "正在搜索知识库并提取相关证据。",
    askProgressWritingTitle: "撰写答案",
    askProgressWritingDesc: "正在综合证据并生成最终回答。",
    coverageTitle: "检索覆盖范围",
    totalSources: "来源总数",
    embeddedSources: "可检索来源",
    retrievedSources: "本次命中来源",
    askHistory: "提问历史",
    noAskHistory: "暂无提问历史",
    restoreHistory: "恢复",
    clearAskHistory: "清空历史",
  },
  podcasts: {
  ...
  settings: {
    ...
    firecrawlApiKeyPlaceholder: "请输入 Firecrawl API Key",
    jina: "Jina",
    ...
    sourceBatchLimit: "添加来源数量上限",
    sourceBatchLimitHelp: "单个笔记本允许包含的来源数量上限，包括新添加来源和添加现有来源，默认 50。",
    loadFailed: "加载设置失败",
    webSearch: "联网搜索",
    webSearchDesc: "配置 Tavily Search API 以启用网络搜索",
    ...
    redaction: {
      ...
      enableLabel: "启用出网脱敏",
      enableHelp: "开启后，发往外部大模型的内容将自动把词典中的敏感词替换为代号，模型返回后在界面自动还原。库内存储与搜索始终使用原文，不受影响。",
      dictTitle: "脱敏词典",
      dictHelp: "维护敏感词与替换代号的对照。同一敏感词全程使用同一代号；井号、产品代号、电话号码可自动识别，人名等请手工添加。",
      original: "敏感词（原文）",
      originalPlaceholder: "如：张三 / 欧美克 / 宁218-1井",
      alias: "替换代号",
      aliasPlaceholder: "如：工程师A / 某企业 / 实验井A",
      category: "类别",
      categories: {
        company: "公司名称",
        address: "地址信息",
      ...
      deleteRule: "删除",
      noRules: "暂无词典条目",
      deleteConfirmTitle: "删除词典条目",
      deleteConfirmDescription: "确定要删除「{original}」吗？删除后该敏感词将不再被自动替换。",
      ruleAdded: "词典条目已添加",
      ruleUpdated: "词典条目已更新",
      ruleDeleted: "词典条目已删除",
    },
    userApproval: {
      title: "成员注册审批与账号管理",
      description: "批准、拒绝或停用系统成员，保障科研数据资产安全隔离",
      fetchFailed: "获取成员列表失败",
      statusApproved: "已成功批准该成员账号并激活",
      statusRejected: "已拒绝该成员账号申请",
      rolePromoted: "已将该成员提升为管理员",
      roleRevoked: "已取消该成员的管理员权限",
      ...
      noMembers: "没有找到符合筛选条件的成员",
      roleRevokeTitle: "点击取消管理员权限",
      rolePromoteTitle: "点击提升为管理员",
      adminRole: "管理员",
      userRole: "用户",
      registeredAt: "注册时间",
      status: {
      ...
      approveActivate: "批准并激活",
      rejectApplication: "拒绝申请",
      disableAccount: "禁用账号",
      resetPassword: "重置密码",
      confirmApproveTitle: "批准成员账号",
      confirmRejectTitle: "拒绝 / 禁用成员账号",
      confirmApproveDesc: "此操作将激活该成员的账号，该成员将以普通用户身份登录系统。",
      confirmRejectDesc: "此操作将拒绝该成员的注册申请或禁用其账号，该成员将无法登录系统。",
      resetPasswordDesc: "请为该成员设置一个新密码，并确认输入无误。",
      newPassword: "新密码",
      confirmNewPassword: "确认新密码",
      newPasswordPlaceholder: "请输入至少 6 位的新密码",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Lumina 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 Lumina 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，Lumina 可能无法正常运行。",
    ...
    contextOnDemand: "按需检索模式；上下文会随研究步骤动态变化",
    contextEstimated: "估算",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "未配置上下文上限",
    contextProgressLabel: "模型上下文用量：{percent}%",
    contextPending: "发送下一条问题后更新用量",
    editContextWindow: "编辑上下文窗口",
    contextWindowDialogTitle: "模型上下文窗口",
    contextWindowDialogDesc: "设置 {model} 的最大上下文窗口。",
    contextWindowTokensLabel: "上下文窗口（词元）",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 Lumina 中启用 AI 服务商。",
    ...
    test: "测试",
    hasLinkedModels: "此凭证包含 {count} 个关联模型。",
    migrateModelsTo: "将模型迁移至：",
    key: "密钥",
  },
  usage: {
    title: "AI 词元用量",
    description: "按时间段、API 密钥、模型和工作流查看词元消耗。",
    period: "时间范围",
    period7: "近 7 天",
    period30: "近 30 天",
    period90: "近 90 天",
    ...
    tokens: "词元",
    dailyUsage: "每日用量",
    dailyUsageDesc: "所选时间范围内每天记录的总词元。",
    byCredential: "按密钥统计",
    byCredentialDesc: "比较不同已存凭据和环境变量密钥的词元消耗。",
    byUser: "按用户统计",
    byUserDesc: "比较所选范围内不同用户的词元消耗。",
    recentUsage: "最近活动",
    recentUsageDesc: "所选范围内最近 50 条 AI 操作审计记录。",
    noUsage: "此时间范围内没有词元用量记录。",
    loading: "正在加载用量...",
    loadError: "无法加载用量数据。",
    model: "模型",
    key: "密钥",
    ...
    status: "状态",
    source: "统计来源",
    providerReported: "服务商",
    estimated: "估算",
    success: "成功",
    failed: "失败",
    callsCount: "{count} 次调用",
    providerReportedHint: "优先使用服务商返回的词元数；估算值会明确标注。",
    adminHint: "管理员可审计全部用户，但不会看到提示词或回答内容。",
    surfaceNotebookQuick: "笔记本快速对话",
    surfaceNotebookResearch: "笔记本研究对话",
    surfaceSourceChat: "来源对话",
    surfaceGlobalAsk: "全局提问",
    surfaceTransformation: "转换",
    surfaceNoteGeneration: "笔记生成",
    surfaceNotebookGuide: "笔记本指南",
    surfaceModelTest: "模型测试",
    surfaceCredentialManagement: "凭据管理",
    surfaceSourceProcessing: "来源处理",
    surfaceKnowledgeGraph: "知识图谱",
    surfaceEmbedding: "向量嵌入",
    surfaceEmbeddingRebuild: "重建向量嵌入",
    surfaceApi: "API",
    surfaceUnknown: "其他",
  },
  setupBanner: {
