...
export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Lumina não pôde ser alcançado",
    ...
    docLink: "Documentação do Lumina",
  ...
  sources: {
    ...
    downloadMarkdownPackage: "Baixar Markdown + imagens",
    ...
    selectMultipleFilesHint: "Selecione múltiplos arquivos para importação em lote. Suportados: Documentos (PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, XLSM, EPUB, TXT, MD)",
    ...
    backToSources: "Voltar para Fontes",
    ...
    continuingDuplicateUpload: "Continuando upload...",
  },
  chat: {
    ...
    quickChat: "Conversa rápida",
    researchAgent: "Research Agent",
    crossNotebookDiscovery: "Descoberta entre cadernos",
    scientificDatabases: "Bases de dados científicas",
    researchSkills: "Métodos de pesquisa",
    researchSkillsAuto: "Métodos: automático",
    researchSkillsOff: "Métodos: desativados",
    researchSkillsSelected: "Métodos: {count} selecionados",
    researchSkillsChoose: "Escolha até 3 métodos",
    researchSkillsLimit: "Os métodos selecionados valem apenas para esta solicitação; o modo automático carrega até 2.",
    researchSkillNames: {
      literatureDoiVerification: "Busca bibliográfica e verificação de DOI",
      evidenceCriticalAppraisal: "Classificação de evidências e análise crítica",
      competingHypotheses: "Geração e comparação de hipóteses",
      doeStatisticalPlan: "DOE e plano de análise estatística",
      chemicalIdentityProperties: "Identidade química e verificação de propriedades",
      formulationCompatibilityMatrix: "Matriz de risco de compatibilidade da formulação",
      hthpBrineValidation: "Projeto de validação HTHP e salmoura",
      scaleUpValidationGates: "Riscos de ampliação e gates de validação",
      structuredResearchReport: "Redação estruturada de relatório científico",
      oilwellCementAdditiveDiagnosis: "Diagnóstico de aditivos para cimento de poço",
    },
    progressWorking: "Em execução",
    progressReceived: "Pergunta recebida",
    progressPreparingContext: "Preparando o material selecionado",
    progressContextReady: "Material da conversa pronto",
    progressPlanning: "Analisando a pergunta e selecionando ferramentas",
    progressInspectingScope: "Verificando o escopo da pesquisa",
    progressSearchingNotebook: "Pesquisando neste caderno",
    progressReadingEvidence: "Lendo evidências relevantes",
    progressSearchingCrossNotebook: "Pesquisando entre cadernos",
    progressSearchingWeb: "Pesquisando na Web",
    progressInspectingScientificDatabases: "Verificando bases científicas disponíveis",
    progressSearchingScientificDatabases: "Pesquisando em bases científicas",
    progressReadingScientificRecord: "Lendo um registro científico",
    progressLoadingResearchSkills: "Carregando métodos de pesquisa",
    progressUsingResearchTool: "Executando uma ferramenta de pesquisa",
    progressAwaitingModel: "Aguardando a resposta do modelo",
    progressSynthesizing: "Comparando evidências e organizando conclusões",
    progressModelStreaming: "Gerando a resposta",
    progressCompleteSummary: "{count} etapas concluídas em {seconds}s",
    progressErrorSummary: "Interrompido com erro após {seconds}s",
    progressCancelledSummary: "Interrompido após {seconds}s",
    progressExpand: "Expandir atividade",
    progressCollapse: "Recolher atividade",
  ...
  searchPage: {
    ...
    askBeta: "Perguntar",
    search: "Buscar",
    askYourKb: "Pergunte à Sua Base de Conhecimento",
    ...
    askProgressTitle: "Pergunta recebida, trabalhando nela",
    askProgressComplete: "Resposta concluída",
    askProgressError: "Algo deu errado durante o processamento",
    askProgressCancelled: "Processamento interrompido",
    askProgressElapsed: "{seconds}s decorridos",
    askProgressNote: "Perguntas amplas podem levar mais tempo porque o Ask precisa planejar, recuperar, ler e resumir.",
    askProgressReceivedTitle: "Recebida",
    askProgressReceivedDesc: "Pergunta e modelos confirmados.",
    askProgressPlanningTitle: "Planejando",
    askProgressPlanningDesc: "Decidindo quais materiais procurar.",
    askProgressSearchingTitle: "Pesquisando",
    askProgressSearchingDesc: "Pesquisando a base de conhecimento e lendo evidências relevantes.",
    askProgressWritingTitle: "Escrevendo",
    askProgressWritingDesc: "Sintetizando as evidências na resposta final.",
    coverageTitle: "Cobertura de recuperação",
    totalSources: "Total de fontes",
    embeddedSources: "Fontes pesquisáveis",
    retrievedSources: "Fontes encontradas nesta pergunta",
    askHistory: "Histórico de perguntas",
    noAskHistory: "Ainda não há histórico de perguntas.",
    restoreHistory: "Restaurar",
    clearAskHistory: "Limpar histórico",
  },
  podcasts: {
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Lumina exclua arquivos enviados da pasta de upload automaticamente.",
    ...
    redaction: {
      title: "Mascaramento de Conteúdo (Proteção de Saída)",
      description: "Termos sensíveis são substituídos antes do envio a provedores de IA externos e restaurados no retorno; o conteúdo armazenado permanece intacto",
      enableLabel: "Ativar mascaramento de saída",
      enableHelp: "Quando ativo, os prompts enviados a LLMs externos substituem termos do dicionário por aliases, e as respostas são restauradas automaticamente na interface. O conteúdo armazenado e a pesquisa sempre usam o texto original.",
      dictTitle: "Dicionário de Mascaramento",
      dictHelp: "Gerencie o mapeamento termo sensível -> alias. Cada termo mantém um alias estável para sempre; poços, códigos de produto e telefones são detectados automaticamente - adicione nomes manualmente.",
      original: "Termo sensível",
      originalPlaceholder: "ex.: nome de pessoa ou empresa",
      alias: "Alias",
      aliasPlaceholder: "ex.: Engenheiro A",
      category: "Categoria",
      categories: {
        company: "Empresa",
        address: "Endereço",
      ...
      addRule: "Adicionar",
      deleteRule: "Excluir",
      noRules: "Nenhuma entrada no dicionário",
      deleteConfirmTitle: "Excluir entrada",
      deleteConfirmDescription: "Excluir '{original}'? O termo não será mais substituído automaticamente.",
      ruleAdded: "Entrada adicionada",
      ruleUpdated: "Entrada atualizada",
      ruleDeleted: "Entrada excluída",
    },
  },
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Lumina está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Lumina",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Lumina pode não funcionar corretamente sem eles.",
    ...
    contextOnDemand: "Recuperação sob demanda; o contexto muda em cada etapa da pesquisa",
    contextEstimated: "estimado",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "Limite de contexto não configurado",
    contextProgressLabel: "Uso do contexto do modelo: {percent}%",
    contextPending: "O uso será atualizado após a próxima pergunta",
    editContextWindow: "Editar janela de contexto",
    contextWindowDialogTitle: "Janela de contexto do modelo",
    contextWindowDialogDesc: "Defina a janela de contexto máxima para {model}.",
    contextWindowTokensLabel: "Janela de contexto (tokens)",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Lumina.",
