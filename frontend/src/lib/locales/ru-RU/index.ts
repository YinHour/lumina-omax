...
export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Lumina недоступен",
  ...
  sources: {
    ...
    downloadMarkdownPackage: "Скачать Markdown + изображения",
    ...
    selectMultipleFilesHint: "Выберите несколько файлов для пакетного импорта. Поддерживаются: Документы (PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, XLSM, EPUB, TXT, MD)",
    ...
    backToSources: "Назад к источникам",
    ...
    continuingDuplicateUpload: "Продолжаем загрузку...",
  },
  chat: {
    ...
    exportUserLabel: "Пользователь",
    exportAssistantLabel: "Ассистент",
    sessions: "Сессии",
    ...
    crossNotebookDiscovery: "Поиск по блокнотам",
    scientificDatabases: "Научные базы данных",
    researchSkills: "Методы исследования",
    researchSkillsAuto: "Методы: автоматически",
    researchSkillsOff: "Методы: выключены",
    researchSkillsSelected: "Методы: выбрано {count}",
    researchSkillsChoose: "Выберите до 3 методов",
    researchSkillsLimit: "Выбранные методы применяются только к этому запросу; автоматически загружается до 2.",
    researchSkillNames: {
      literatureDoiVerification: "Поиск литературы и проверка DOI",
      evidenceCriticalAppraisal: "Оценка доказательств и критический анализ",
      competingHypotheses: "Формирование и сравнение гипотез",
      doeStatisticalPlan: "DOE и план статистического анализа",
      chemicalIdentityProperties: "Проверка химической идентичности и свойств",
      formulationCompatibilityMatrix: "Матрица рисков совместимости рецептуры",
      hthpBrineValidation: "План проверки HTHP и рассола",
      scaleUpValidationGates: "Риски масштабирования и контрольные этапы",
      structuredResearchReport: "Структурированный научный отчёт",
      oilwellCementAdditiveDiagnosis: "Диагностика добавок к скважинному цементу",
    },
    progressWorking: "Выполняется",
    progressReceived: "Вопрос получен",
    progressPreparingContext: "Подготовка выбранных материалов",
    progressContextReady: "Материалы для диалога готовы",
    progressPlanning: "Анализ вопроса и выбор инструментов",
    progressInspectingScope: "Проверка области исследования",
    progressSearchingNotebook: "Поиск в этом блокноте",
    progressReadingEvidence: "Изучение релевантных данных",
    progressSearchingCrossNotebook: "Поиск по другим блокнотам",
    progressSearchingWeb: "Поиск в интернете",
    progressInspectingScientificDatabases: "Проверка доступных научных баз данных",
    progressSearchingScientificDatabases: "Поиск в научных базах данных",
    progressReadingScientificRecord: "Чтение записи научной базы данных",
    progressLoadingResearchSkills: "Загрузка методов исследования",
    progressUsingResearchTool: "Запуск исследовательского инструмента",
    progressAwaitingModel: "Ожидание ответа модели",
    progressSynthesizing: "Сопоставление данных и подготовка выводов",
    progressModelStreaming: "Формирование ответа",
    progressCompleteSummary: "Выполнено шагов: {count}, время: {seconds} с",
    progressErrorSummary: "Остановлено с ошибкой через {seconds} с",
    progressCancelledSummary: "Остановлено через {seconds} с",
    progressExpand: "Развернуть ход выполнения",
    progressCollapse: "Свернуть ход выполнения",
  ...
  searchPage: {
    ...
    askBeta: "Запрос",
    search: "Поиск",
    askYourKb: "Спросите базу знаний",
    ...
    askProgressTitle: "Вопрос получен, идет обработка",
    askProgressComplete: "Ответ готов",
    askProgressError: "Во время обработки возникла проблема",
    askProgressCancelled: "Обработка остановлена",
    askProgressElapsed: "Прошло {seconds}с",
    askProgressNote: "Широкие вопросы могут занимать больше времени: Ask планирует, ищет, читает и обобщает.",
    askProgressReceivedTitle: "Получено",
    askProgressReceivedDesc: "Вопрос и настройки моделей подтверждены.",
    askProgressPlanningTitle: "Планирование",
    askProgressPlanningDesc: "Определяем, какие материалы искать.",
    askProgressSearchingTitle: "Поиск",
    askProgressSearchingDesc: "Ищем в базе знаний и читаем релевантные доказательства.",
    askProgressWritingTitle: "Ответ",
    askProgressWritingDesc: "Обобщаем доказательства в итоговый ответ.",
    coverageTitle: "Покрытие поиска",
    totalSources: "Всего источников",
    embeddedSources: "Доступные для поиска источники",
    retrievedSources: "Источники, найденные для этого вопроса",
    askHistory: "История вопросов",
    noAskHistory: "Истории вопросов пока нет.",
    restoreHistory: "Восстановить",
    clearAskHistory: "Очистить историю",
  },
  podcasts: {
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Lumina автоматически удалять загруженные файлы из папки загрузок.",
    ...
    redaction: {
      title: "Маскирование данных (защита исходящего трафика)",
      description: "Конфиденциальные термины автоматически заменяются перед отправкой внешним AI-моделям и восстанавливаются в ответах; хранимые данные не затрагиваются",
      enableLabel: "Включить маскирование",
      enableHelp: "После включения термины из словаря автоматически заменяются псевдонимами в запросах к внешним LLM, а ответы автоматически восстанавливаются в интерфейсе. Хранилище и поиск всегда используют исходный текст.",
      dictTitle: "Словарь маскирования",
      dictHelp: "Управление соответствием терминов и псевдонимов. Каждый термин всегда использует один псевдоним; номера скважин, коды продуктов и телефоны распознаются автоматически - имена добавляйте вручную.",
      original: "Термин (оригинал)",
      originalPlaceholder: "напр. имя или название компании",
      alias: "Псевдоним",
      aliasPlaceholder: "напр. Инженер A",
      category: "Категория",
      categories: {
        company: "Компания",
        address: "Адрес",
      ...
      addRule: "Добавить",
      deleteRule: "Удалить",
      noRules: "Словарь пуст",
      deleteConfirmTitle: "Удалить запись",
      deleteConfirmDescription: "Удалить «{original}»? Термин больше не будет автоматически заменяться.",
      ruleAdded: "Запись добавлена",
      ruleUpdated: "Запись обновлена",
      ruleDeleted: "Запись удалена",
    },
  },
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Lumina.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Lumina",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Lumina может работать некорректно без них.",
    ...
    contextOnDemand: "Поиск по запросу; контекст меняется на каждом этапе исследования",
    contextEstimated: "оценка",
    contextUsage: "{used} / {total}",
    contextPercent: "{percent}%",
    contextLimitUnknown: "Лимит контекста не настроен",
    contextProgressLabel: "Использование контекста модели: {percent}%",
    contextPending: "Данные обновятся после следующего вопроса",
    editContextWindow: "Изменить окно контекста",
    contextWindowDialogTitle: "Окно контекста модели",
    contextWindowDialogDesc: "Укажите максимальное окно контекста для {model}.",
    contextWindowTokensLabel: "Окно контекста (токены)",
    contextWindowPlaceholder: "Например, 1000000",
    contextWindowBuiltinHint: "Встроенное значение: {count} токенов. Введите другое значение или очистите поле, чтобы использовать встроенное.",
    contextWindowOverrideHint: "Введите лимит, опубликованный провайдером. Очистите поле, если лимит неизвестен.",
    contextWindowTestSaved: "Автоматически определено и сохранено во время этой проверки.",
  },
  apiKeys: {
    title: "Настройте ИИ с помощью собственных API-ключей",
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Lumina.",
