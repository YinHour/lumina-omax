...
This guide is for developers working on Lumiton·Omax. For end-user documentation, see [README.md](README.md) and [docs/](docs/).
...
Lumiton·Omax supports internationalization. To add a new language:
