# Lumiton·Omax Architecture

## High-Level Overview

Lumiton·Omax follows a three-tier architecture with clear separation of concerns:
...
LangGraph is a state machine library that orchestrates multi-step AI workflows. Lumiton·Omax uses five core workflows:
