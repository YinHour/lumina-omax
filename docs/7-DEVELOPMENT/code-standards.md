...
This document outlines coding standards and best practices for Lumiton·Omax contributions. All code should follow these guidelines to ensure consistency, readability, and maintainability.
...
managing research notebooks within the Lumiton·Omax system.
"""
```
...
class Notebook(BaseModel):
    ...
    Notebooks are the primary organizational unit in Lumiton·Omax, allowing
