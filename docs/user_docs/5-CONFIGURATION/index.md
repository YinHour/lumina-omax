...
Configuration is how you customize Lumiton·Omax for your specific setup. This section covers what you need to know.
...
You will only use .env if you are running Lumiton·Omax locally.
...
```
1. Open Lumiton·Omax in your browser
