...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Lumiton·Omax
...
```yaml
# In your Lumiton·Omax docker-compose.yml
environment:
...
### Step 5: Add Model in Lumiton·Omax
...
### Lumiton·Omax in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### Lumiton·Omax in Docker (Linux)
...
# From inside Lumiton·Omax container
