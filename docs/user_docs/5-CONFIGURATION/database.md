...
Lumiton·Omax uses SurrealDB for its database needs. 

---

## Default Configuration

Lumiton·Omax should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as Lumiton·Omax (recommended)
...
### DB running in the host machine and Lumiton·Omax running in Docker
...
### Lumiton·Omax and Surreal are running on the same machine
