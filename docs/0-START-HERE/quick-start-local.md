...
Get Lumiton·Omax running with **100% local AI** using Ollama. No cloud API keys needed, completely private.
...
## Step 5: Access Lumiton·Omax (instant)
...
4. In Lumiton·Omax, go to **Settings** → **API Keys**
