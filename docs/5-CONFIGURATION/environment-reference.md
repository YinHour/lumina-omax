...
Comprehensive list of all environment variables available in Lumiton·Omax.
...
| `OPEN_NOTEBOOK_PASSWORD` | No | None | Password to protect Lumiton·Omax instance |
...
| `LANGCHAIN_PROJECT` | No | Lumiton·Omax | LangSmith project name |
